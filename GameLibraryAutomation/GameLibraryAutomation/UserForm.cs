    ...
    public partial class UserForm : Form
    {
        ...
        private void passwordTBox_Enter(object sender, EventArgs e)
        {
            if (passwordLTBox.Text == "Şifre")
            {
                ...
                passwordLTBox.UseSystemPasswordChar = false;
        ...
        private void passwordTBox_Leave(object sender, EventArgs e)
        {
            if (passwordLTBox.Text == "")
            {
                ...
                passwordLTBox.UseSystemPasswordChar = true;
        ...
        private void loginButton_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("SELECT username, password FROM userTable WHERE username=@username AND password=@password", con);
        ...
        private void registerButton_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmdLogin = new SqlCommand("SELECT username, email FROM userTable WHERE username=@username AND email=@email", con);
                ...
                else
                {
                    ...
                    SqlCommand cmdRegister = new SqlCommand("INSERT INTO userTable (username, email, password, level, rank, balance, profilepic, profilebanner) VALUES (@username, @email, @password, @profilepic, @profilebanneri @level)", con);
                    ...
                    byte[] bannerbytes = (byte[])(new ImageConverter()).ConvertTo(Resources.profile, typeof(byte[]));
